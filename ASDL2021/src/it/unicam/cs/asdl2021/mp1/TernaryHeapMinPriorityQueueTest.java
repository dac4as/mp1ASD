...
class TernaryHeapMinPriorityQueueTest {
    ...
    void decreasePriority() {
        assertThrows(NoSuchElementException.class, () -> new TernaryHeapMinPriorityQueue().decreasePriority(null, 5.d));
        ternMinPrHeap.clear();
    ...
    private int getParentIndex(int index){return (index-1)/3;}
